...
<div class="<?php echo $pluralVar;?> view">
	<h2>
	<?php printf(__("View %s", true), $singularHumanName); ?>
	</h2>
	<dl>
	<?php
	$i = 0;
...
<div class="related">
	<h3>
	<?php printf(__("Related %s", true), Inflector::humanize($_details['controller'])); ?>
	</h3>
...
<div class="related">
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(sprintf(__("New %s", true), Inflector::humanize(Inflector::underscore($_alias))), array('controller' => $_details['controller'], 'action' => 'add'));?>
			</li>
		</ul>
	</div>
</div>
